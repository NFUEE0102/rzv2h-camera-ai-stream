 ...
 * the SAME byte layout in Python (stream_viewer.py).
 *
 * ---------------------------------------------------------------------------
 ...
 *    <16-byte UUID>         SEI_BOX_UUID below (ASCII "DETBOXSEI01_DRPI")
...
/* 16-byte UUID for our user_data_unregistered SEI. ASCII "DETBOXSEI01_DRPI"
