#!/usr/bin/env python3
"""
link_proto.py -- shared discovery + control wire protocol for the RZ/V2H UAV
...
(app_m5 on the board, uav_view.py on the PC) are spawned as subprocesses by the
...
DISCOVER_MAGIC = "UAVLINK_DISCOVER_V1"   # RX -> broadcast
OFFER_MAGIC    = "UAVLINK_OFFER_V1"      # TX -> unicast reply
